...
class TextsControllerTest < ActionController::TestCase
  ...
  test "should create text" do
    assert_difference('Text.count') do
      post :create, text: { header_external: @text.header_external, header_external_link: @text.header_external_link }
    end
  ...
  test "should update text" do
    patch :update, id: @text, text: { header_external: @text.header_external, header_external_link: @text.header_external_link }
    assert_redirected_to text_path(assigns(:text))
  end
